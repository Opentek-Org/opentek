...
function loadData(data) {
    ...
    for (let i = 0; i < data.length; i++) {
       ...
       <div class="card">
          ...
          <button class="btn card_btn" onclick='getRoadMap("${data[i].roadmap}", "${data[i].title}")'>View Road Map</button>
       </div>
       </li>
   `     
    }
...
function getRoadMap(name, head){
    ...
    $("#roadimg").html(`<div><h1>${head} <br/>RoadMap </h1><img src="${data[name]}" alt="roadmap_img"/></div>`)
}
